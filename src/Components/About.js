    ...
    return (
        <div className='about-contents'>
            ...
            <motion.div initial={{ x: 100, opacity: 0 }} whileInView={{
                ...
                <h2>About us</h2>
                <p>
                    We help businesses leverage the power of Value-Added Services (VAS) and SMS by providing access to our bespoke carrier grade messaging and VAS platforms, which has direct connectivity to all the major mobile network operators in Nigeria.<br /><br />

                    Our platform features extend beyond that of a regular VAS and SMS gateway to provide the following extensive services:
