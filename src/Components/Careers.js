...
// import Trusted from "../Assets/carrergrowt.png";
...
//                         <strong>Are you a passionate individual who thrives in a collaborative environment? </strong>Do you seek constant learning and growth opportunities? Then look no further! At Gemini, we are constantly searching for passionate and talented individuals to help us drive innovation and make a real impact.
//                     </p>
//                 </motion.div>
//                 <motion.div 
//                     initial={{ x: 100, opacity: 0 }} 
...
//                     <h3 style={{color: '#244886'}} className='head-three'>Why you Should Join Our Team</h3>
//                     <p style={{
//                         fontFamily: "Rubik",
//                         fontSize: ".88rem",
//                         color: "#001833",
...
//                             <h4 style={{color: '#244886'}} className='head-four'>One Team</h4>
//                             <p className='two-body'>
//                                 Work alongside inspiring colleagues: Be part of a passionate team dedicated to pushing boundaries and achieving excellence. Contribute to meaningful work that shapes the future of our industry.
//                             </p>
//                         </motion.div>
//                         <motion.div whileHover={{ scale: 1.03 }} className='cpt-bone-two'>
//                             <img className='team-work' src={Trusted} alt="teamwork"></img>
//                             <h4 style={{color: '#244886'}} className='head-four'>Career Growth</h4>
//                             <p className='two-body'>
...
//                             <h4 style={{color: '#244886'}} className='head-four'>Learning and Development</h4>
//                             <p className='two-body'>
...
//                             <h4 style={{color: '#244886'}} className='head-four'>Flexibility</h4>
//                             <p className='two-body'>
...
//                     initial={{ scale: 0.05 }} 
//                     whileInView={{ scale: 1 }} 
//                     transition={{ type: "spring", stiffness: 60, ease: "easeIn", delay: 0.0008, duration: 0.02 }} 
//                     className='head-five' style={{color: '#244886'}}>
//                     Open Roles
//                 </motion.h2>
//                 {errorMessage ? (
        ...
        <div className='careers-container'>
            ...
            <div className='careers-page-two'>
                <div className='cpt-side-a'>
                    ...
                    <h3 className='head-three' style={{color: '#244886'}}>Why you should join our Team</h3>
                    <p style={{
                        fontFamily: "Rubik",
                        fontSize: ".88rem",
                        color: "#001833",
            ...
            <div className='careers-page-three'>
                <motion.h2 initial={{ scale: 0.05 }} whileInView={{ scale: 1 }} transition={{ type: "spring", stiffness: 60, ease: "easeIn", delay: 0.0008, duration: 0.02 }} style={{color: '#244886'}} className='head-five'>Open Roles</motion.h2>
